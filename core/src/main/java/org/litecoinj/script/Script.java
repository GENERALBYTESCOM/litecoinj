...
public class Script {
    ...
    public byte[] getProgram() {
        try {
            // Don't round-trip as Litecoin Core doesn't and it would introduce a mismatch.
            if (program != null)
     ...
     * Litecoin Core does something similar.</p>
     */
     ...
     * The concept of a "from address" isn't well defined in Litecoin and you should not assume the sender of a
     ...
     * not exist in Litecoin Core. It means blocks containing P2SH transactions that don't match
     * correctly are considered valid, but won't be mined upon, so they'll be rapidly re-orgd out of the chain. This
     * logic is defined by <a href="https://github.com/litecoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a>.</p>
     *
    ...
    private static boolean castToBool(byte[] data) {
        ...
        {
            // "Can be negative zero" - Litecoin Core (see OpenSSL's BN_bn2mpi)
            if (data[i] != 0)
     ...
     *
     * @deprecated Use {@link #executeScript(org.litecoinj.core.Transaction, long, org.litecoinj.script.Script, LinkedList, Set)}
     * instead.
     */
    @Deprecated
    ...
    // This is more or less a direct translation of the code in Litecoin Core
    ...
    private static int executeMultiSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        // We uselessly remove a stack object to emulate a Litecoin Core bug.
     ...
     * @deprecated Use {@link #correctlySpends(org.litecoinj.core.Transaction, long, org.litecoinj.script.Script, Set)}
